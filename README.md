You will need to change the site's persmissions in order to hear the wonderful music on most browsers. To do so you generally need to set 'Audio' to ALLOW instead of either ASK or AUTOMATIC.
